	        ...
	        <form method="POST" action="animal.php">
				...
				if ($db_conn) {
		            ...
		            if (array_key_exists('GameBoy', $_POST)) {
		                ...
		                $animalquery = "update purchaseanimal set hydration=(select max(case when hydration-5<0 then 0 else (select hydration-5 from purchaseanimal where zooname='" . $zooname . "' and name='" . $animalname . "') end) from purchaseanimal where name='" . $animalname . "' and zooname='" . $zooname . "'), hygiene=(select max(case when hygiene-20<0 then 0 else (select hygiene-20 from purchaseanimal where zooname='" . $zooname . "' and name='" . $animalname . "') end) from purchaseanimal where name='" . $animalname . "' and zooname='" . $zooname . "'), fullness=(select max(case when fullness-5<0 then 0 else (select fullness-5 from purchaseanimal where zooname='" . $zooname . "' and name='" . $animalname . "') end) from purchaseanimal where name='" . $animalname . "' and zooname='" . $zooname . "'), happiness=(select max(case when happiness<0 then 0 else (select happiness+30 from purchaseanimal where zooname='" . $zooname . "' and name='" . $animalname . "') end) from purchaseanimal where name='" . $animalname . "' and zooname='" . $zooname . "') where zooname='" . $zooname . "' and name='" . $animalname . "'";
		            ...
		            if (array_key_exists('WhiteRussian', $_POST)) {
		                ...
		                $animalquery = "update purchaseanimal set hydration=(select max(case when hydration<0 then 0 else (select hydration-25 from purchaseanimal where zooname='" . $zooname . "' and name='" . $animalname . "') end) from purchaseanimal where name='" . $animalname . "' and zooname='" . $zooname . "'), hygiene=(select max(case when hygiene-20<0 then 0 else (select hygiene-25 from purchaseanimal where zooname='" . $zooname . "' and name='" . $animalname . "') end) from purchaseanimal where name='" . $animalname . "' and zooname='" . $zooname . "'), fullness=(select max(case when fullness-5<0 then 0 else (select fullness+50 from purchaseanimal where zooname='" . $zooname . "' and name='" . $animalname . "') end) from purchaseanimal where name='" . $animalname . "' and zooname='" . $zooname . "'), happiness=(select max(case when happiness<0 then 0 else (select happiness+50 from purchaseanimal where zooname='" . $zooname . "' and name='" . $animalname . "') end) from purchaseanimal where name='" . $animalname . "' and zooname='" . $zooname . "') where zooname='" . $zooname . "' and name='" . $animalname . "'";
